...
class ResetPasswordController extends AbstractController
{
     ...
     */
    #[Route('', name: 'visitor.authentication.forgot_password_request')]
    ...
    public function reset(Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        if ($token) 
        {
            ...
            return $this->redirectToRoute('visitor.authentication.reset_password');
        }
        ...
        try 
        {
            ...
            return $this->redirectToRoute('visitor.authentication.forgot_password_request');
        }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("success", "Votre mot de passe a été réinitialiser. Vous pouvez vous connecter");
